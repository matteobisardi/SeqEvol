...
function evolMSA(output_path::AbstractString, params_path::AbstractString, wt_path::AbstractString; steps::Integer = 10, nseq::Integer = 100, T::Float64 = 1, wt_name = "unknown wt") 
...
function evolMSA(output_path::AbstractString, params::Tuple{Array{Float64, 2}, Array{Float64, 4}}, wt_path::AbstractString; steps::Integer = 10, nseq::Integer = 100, T::Float64 = 1, wt_name::AbstractString = "unknown wt") 
	h, J = params
	DNA_seq = readdlm(wt_path)[:, 1]
	amino_seq = [cod2amino[codon] for codon in DNA_seq]
	seed_seq = SeqToEvolve(amino_seq, DNA_seq)
